...
import { addNewProject,sleectProjectByIdentifier, updateProject } from "../project/projectSlice";
import { useParams } from "react-router-dom";
function AddProjectForm(props){

    const {projectId}=useParams();
    const project=useSelector((state)=>sleectProjectByIdentifier(state,String(projectId)))
